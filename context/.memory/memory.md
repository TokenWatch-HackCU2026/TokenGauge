# TokenWatch — Project Memory

This file stores persistent context, decisions, and conventions for the TokenWatch project.
...
- **Project Board**: https://github.com/orgs/TokenWatch-HackCU2026/projects/1
- **Event**: HackCU 2026
...
All traffic routes through TokenWatch so that usage logging, key security, rate limiting, and model optimization all happen at a single, centralized layer. Users never call AI providers directly.
...
# Database
MONGODB_URI=mongodb://localhost:27017/tokenwatch
